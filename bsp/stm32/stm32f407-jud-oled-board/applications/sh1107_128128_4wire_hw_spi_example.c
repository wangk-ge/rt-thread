...
static void sh1107_128128_4wire_hw_spi_example(int argc,char *argv[])
{
    u8g2_t u8g2;

    // Initialization
    u8g2_Setup_sh1107_128x128_f(&u8g2, U8G2_R0, u8x8_byte_rt_4wire_hw_spi, u8x8_rt_gpio_and_delay);
...
MSH_CMD_EXPORT(sh1107_128128_4wire_hw_spi_example, sw 4wire spi sh1107 sample);
